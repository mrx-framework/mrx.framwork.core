      ...
      <v-col cols="9">
        <v-card tile>
          <v-container fluid>
            <v-row>
              <v-col cols="12">
                <v-text-field :label="$t('labels.title')" v-model="blogpost.title" hide-details />
              </v-col>
              <v-col cols="12">
                <v-text-field :label="$t('labels.path')" v-model="blogpost.path" hide-details />
              </v-col>
            </v-row>
          </v-container>
        </v-card>
        ...
        <v-card tile class="mb-5">
          ...
          <v-container fluid>
            <Lookup
              ...
              disableAutofocus
              @onSelected="SELECT_CATEGORY"
              :prefilled="blogpost.category"
            />
          </v-container>
        </v-card>
        ...
        <v-card tile>
          ...
          <v-container fluid>
            <Lookup
              ...
              multiple
              disableAutofocus
              @onSelected="SELECT_TAGS"
              :prefilled="blogpost.tags"
            />
          </v-container>
        </v-card>
      </v-col>
